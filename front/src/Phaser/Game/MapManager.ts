...
export interface MapManagerInterface {
    ...
    update(): void;
    updateOrCreateOtherPlayer(UsersPosition : Array<MessageUserPositionInterface>): void;
}
export class MapManager implements MapManagerInterface{
     ...
     * @param UsersPosition
     */
    updateOrCreateOtherPlayer(UsersPosition : Array<MessageUserPositionInterface>){
