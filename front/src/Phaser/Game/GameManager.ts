...
export interface GameManagerInterface {
    ...
    sharedUserPosition(ListMessageUserPosition : ListMessageUserPositionInterface): void;
}
export class GameManager implements GameManagerInterface {
    ...
    sharedUserPosition(ListMessageUserPosition: ListMessageUserPositionInterface): void {
        ...
        try {
            ...
            if (!Game || !Game.sharedUserPosition) {
                return;
            }
            Game.sharedUserPosition(ListMessageUserPosition.listUsersPosition)
        } catch (e) {
            console.error(e);
        }
    }
